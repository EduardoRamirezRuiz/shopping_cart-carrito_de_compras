          ...
          <ul class="nav navbar-nav navbar-left">
            ...
            <li class="dropdown">
              ...
              <ul class="dropdown-menu">
                ...
                <li class="divider"></li>
                <li><a href="#">Servicio y reparación</a></li>
                <li class="divider"></li>
				  ...
				  <div class="container-fluid">
				    <div class="navbar-header">
				      <div class="navbar" href="#">
				        Satisfacer las demandas del mercado de accesorios celulares ofreciendo, calidad, innovación y variedad en los productos que ofrecemos a nuestros clientes.<br>
...
<!--FIN DEL CAROUSEL-->
			    ...
			    <div class="row">
			    	...
			    	<center>
					    ...
					    <a href="vision.php" type="button" class="btn btn-primary">Visión»</a>
			    	</center>
					</div>
			    	<div class="col-md-3">
