...
<!--INICIO FORM LOGIN-->
   ...
   <div class="col-md-4 contenedor form-signin" id="login">
    <div class="row">
      <div class="row">
      <h4>
      <marquee behavior="slide" scrollamount="50" scrolldelay='0'>
      Si el correo que ingresa existe, recibirá<br> un mensaje con una nueva contraseña
      </marquee>
      </h4>
    </div>
    </div>
      <center>
            <form class="form-signin"  action="../Controlador/validacionLog.php?opc=3" method="post">
