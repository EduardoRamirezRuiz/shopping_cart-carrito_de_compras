    ...
    <div class='col-sm-10 col-md-10'>
      <div class='col-sm-6 col-md-6 text-center'>
        ...
        <?php
          ...
          echo "<form class='form-horizontal' method='POST' action=../Controlador/carrito.php?opc=1&idProd=".$_GET['idProd']." id='frmAnade'>";

          echo   "<h1 class='textBody' id='nomProd' name='nomProd'><strong>".$con_pd->fields[1]."</strong></h1>";
          echo   "<br>";
          echo  "<h3 class='textBody'><strong>Precio</strong><h3><h4 class='textBody' id='precio' name='precio'>$".$con_pd->fields[2]."</h4>";
        ?>
        <!--form class='form-horizontal' method='POST' action="" id='frmAnade' name="frmAnade"-->
          <div class="form-group">
            <h3 class='textBody'><strong>Cantidad</strong><h3>
              <input 
              class="form-control text-center"
              type="number" name="cantidad" id="cantidad" min="1" value="1"
              required>
          </div>
          <input 
            class="btn btn-primary"
            type="submit" value="Añadir al carrito" name="btncarro">
        </form>
